import { MdAssessment, MdOutlineLeaderboard, MdInsights, MdPeople } from "react-icons/md";
...
export default async function SupervisorRelatoriosPage(props: {
  searchParams: SearchParams;
}) {
  const searchParams = await props.searchParams;
  const programaId = typeof searchParams.programa_id === "string" ? searchParams.programa_id : undefined;
  const currentTab = typeof searchParams.tab === "string" ? searchParams.tab : "participacao";
  ...
  const renderTab = () => {
    switch (currentTab) {
      ...
      case "participacao":
      default:
        return <ParticipationTab programaId={programaId} searchParams={searchParams} />;
    }
  };
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-border pb-5">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Analise a participação, o impacto e o ranking de engajamento da coleta premiada.
          </p>
        </div>
