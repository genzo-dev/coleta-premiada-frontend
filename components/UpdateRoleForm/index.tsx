...
} from "@/actions/gestor/update-role-action";
...
export default function UpdateRoleForm({ role }: UpdateRoleFormProps) {
  const initial: UpdateRoleFormState = {
    nome: role.nome,
    descricao: role.descricao ?? "",
    ativo: role.ativo,
  };

  const [state, action, isPending] = useActionState(updateRoleAction, {
    role: initial,
    errors: [],
    success: false,
  });
